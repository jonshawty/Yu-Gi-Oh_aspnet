<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="FrmIcone.aspx.cs" Inherits="YugiohApp.FrmIcone" %>
...
<head runat="server">
    ...
    <title>Gerenciamento de Icone</title>
...
<body id="page-top">
    ...
    <header class="masthead bg-primary text-white text-center">
        <div class="container px-4 text-center">
            ...
            <h2 class="fw-bold">Cadastre um Icone</h2>
        </div>
    </header>
    <style>
        #portfolio {
            ...
            <div class="col-lg-8 col-xl-7">
                <form id="form1" runat="server" style="border-style: groove; padding: 1.5rem; border-radius: 10px; box-shadow: 15px;">
                    <div class="form-floating mb-3">
                        <div>
                            <label>Adicionar Icone:</label>
                        </div>
                        <div>
                            <asp:TextBox
                                runat="server" ID="txtIcone" class="form-control" data-sb-validations="required" />
                        </div>
                    </div>
                    ...
                    <table border="1" class="list-group-item-action bg-gradient">
                        ...
                        <asp:ListView runat="server" ID="lvIcones">
                            <ItemTemplate>
                                <tr>
                                    <td>
                                        <%# Eval("IdIcone") %>
                                    ...
                                    <td>
                                        <a href='<%# "~/Icone?view=1&id=" + Eval("IdIcone") %>'
                                            runat="server">
                            ...
                            <EmptyItemTemplate>
                                <%--Não existem itens!!--%>
                                <strong>Não existem Icones cadastrados!</strong>
                            </EmptyItemTemplate>
                        </asp:ListView>
                    </table>
                </form>
