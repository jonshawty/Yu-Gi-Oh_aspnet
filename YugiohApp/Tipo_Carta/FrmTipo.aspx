<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="FrmTipo.aspx.cs" Inherits="YugiohApp.FrmTipo" %>
...
<head runat="server">
    ...
    <title>Gerenciamento de Tipo</title>
...
<body id="page-top">
        ...
        <div class="container px-4">
           ...
           <div class="collapse navbar-collapse" id="navbarResponsive">
                <ul class="navbar-nav ms-auto">
                    ...
                    <li class="nav-item"><a class="nav-link" href="../Tipo_Carta/FrmTipo.aspx">Gerenciar Tipos</a></li>
    ...
    <header class="masthead bg-primary text-white text-center">
        <div class="container px-4 text-center">
            ...
            <h2 class="fw-bold">Cadastre um Tipo!</h2>
        </div>
    </header>
    <style>
        #portfolio {
            ...
            <div class="col-lg-8 col-xl-7">
                <form id="form1" runat="server" style="border-style: groove; padding: 1.5rem; border-radius: 10px; box-shadow: 15px;">
                    <div class="form-floating mb-3">
                        ...
                        <div>
                            <asp:TextBox
                                runat="server" ID="txtTipoCarta" class="form-control" data-sb-validations="required" />
                        </div>
                    </div>
                    ...
                    <table border="1" class="list-group-item-action bg-gradient">
                        ...
                        <asp:ListView runat="server" ID="lvTipoCarta">
                            <ItemTemplate>
                                <tr>
                                    <td>
                                        <%# Eval("IdTipoCarta") %>
                                    ...
                                    <td>
                                        <a href='<%# "~/Tipo?view=1&id=" + Eval("IdTipoCarta") %>'
                                            runat="server">
                                    ...
                                    <td>
                                        <a href='<%# "~/Tipo?id=" + Eval("IdTipoCarta") %>'
                                            runat="server">
                                    ...
                                    <td>
                                        <p>
                                            <asp:ImageButton
                                                ...
                                                runat="server"
                                                Style="max-width: 20px;"
                                                OnCommand="btnVerificar_Command"
                                                CommandArgument='<%# Eval("NomeTipoCarta") %>'
                            ...
                            <EmptyItemTemplate>
                                <%--Não existem itens!!--%>
                                <strong>Não existem Tipos cadastrados!</strong>
                            </EmptyItemTemplate>
                        </asp:ListView>
                    </table>
                </form>
