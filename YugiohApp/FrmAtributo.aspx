<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="FrmAtributo.aspx.cs" Inherits="YugiohApp.FrmAtributo" %>
...
<head runat="server">
    ...
    <title>Gerenciamento de Atributo</title>
...
<body id="page-top">
    ...
    <header class="masthead bg-primary text-white text-center">
        <div class="container px-4 text-center">
            ...
            <h2 class="fw-bold">Cadastre um Atributo!</h2>
        </div>
    </header>
    <style>
        #portfolio {
            ...
            <div class="col-lg-8 col-xl-7">
                <form id="form1" runat="server" style="border-style: groove; padding: 1.5rem; border-radius: 10px; box-shadow: 15px;">
                    <div class="form-floating mb-3">
                        ...
                        <div>
                            <asp:TextBox
                                runat="server" ID="txtAtributo" class="form-control" data-sb-validations="required" />
                        </div>
                    </div>
                    ...
                    <table border="1" class="list-group-item-action bg-gradient">
                        ...
                        <asp:ListView runat="server" ID="lvAtributos">
                            <ItemTemplate>
                                <tr>
                                    <td>
                                        <%# Eval("IdAtributo") %>
                                    ...
                                    <td>
                                        <a href='<%# "~/Atributo?view=1&id=" + Eval("IdAtributo") %>'
                                            runat="server">
                                    ...
                                    <td>
                                        <a href='<%# "~/Atributo?id=" + Eval("IdAtributo") %>'
                                            runat="server">
                            ...
                            <EmptyItemTemplate>
                                <%--Não existem itens!!--%>
                                <strong>Não existem Atributos cadastrados!</strong>
                            </EmptyItemTemplate>
                        </asp:ListView>
                    </table>
                </form>
