<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="FrmTipoMonstro.aspx.cs" Inherits="YugiohApp.Tipo_Carta.TipoMonstro.FrmTipoMonstro" %>
...
<head runat="server">
    ...
    <title>Gerenciamento de Monstro</title>
...
<body id="page-top">
    ...
    <header class="masthead bg-primary text-white text-center">
        <div class="container px-4 text-center">
            ...
            <h2 class="fw-bold">Cadastre uma Monstro!</h2>
        </div>
    </header>
    <style>
        #portfolio {
            ...
            <div class="col-lg-8 col-xl-7">
                <form id="form1" runat="server" style="border-style: groove; padding: 1.5rem; border-radius: 10px; box-shadow: 15px;">
                    <div class="form-floating mb-3">
                        <div>
                            <label>Adicionar Monstro:</label>
                        </div>
                        <div>
                            <asp:TextBox
                                runat="server" ID="txtMonstro" class="form-control" data-sb-validations="required" />
                        </div>
                    </div>
                        ...
                        <asp:ListView runat="server" ID="lvMonstro">
                            <ItemTemplate>
                                <tr>
                                    ...
                                    <td>
                                        <a href='<%# "~/Monstro?view=1&id=" + Eval("IdMonstro") %>'
                                            runat="server">
                                    ...
                                    <td>
                                        <a href='<%# "~/Monstro?id=" + Eval("IdMonstro") %>'
                                            runat="server">
                                     ...
                                     <td>
                                        <p>
                                            <asp:ImageButton
                                                ...
                                                runat="server"
                                                Style="max-width: 20px;"
                                                OnCommand="btn_VerificaTipo_Command"
                                                CommandArgument='<%# Eval("NomeMonstro") %>'
                            ...
                            <EmptyItemTemplate>
                                <%--Não existem itens!!--%>
                                <strong>Não existem Monstros cadastrados!</strong>
                            </EmptyItemTemplate>
                        </asp:ListView>
                    </table>
                </form>
