<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="FrmMonstroEfeito.aspx.cs" Inherits="YugiohApp.Tipo_Carta.TipoMonstro.Monstro_Efeito.FrmMonstroEfeito" %>
...
<head runat="server">
    ...
    <title>Gerenciamento de Monstro Efeito</title>
...
<body id="page-top">
    ...
    <header class="masthead bg-primary text-white text-center">
        <div class="container px-4 text-center">
            ...
            <h2 class="fw-bold">Cadastre um Monstro Efeito!</h2>
        </div>
    </header>
    <style>
        #portfolio {
            ...
            <div class="col-lg-8 col-xl-7">
                <form id="form1" runat="server" style="border-style: groove; padding: 1.5rem; border-radius: 10px; box-shadow: 15px;">
                    <div class="form-floating mb-3">
                        <div>
                            <label>Adicionar Monstro Efeito:</label>
                        </div>
                        <div>
                            <asp:TextBox
                                runat="server" ID="txtMonstroEfeito" class="form-control" data-sb-validations="required" />
                        </div>
                    </div>
                    ...
                    <table border="1" class="list-group-item-action bg-gradient">
                        ...
                        <asp:ListView runat="server" ID="lvMonstroEfeito">
                            <ItemTemplate>
                                <tr>
                                    <td>
                                        <%# Eval("IdMonstroEfeito") %>
                                    </td>
                                    <td>
                                        <%# Eval("NomeMonstroEfeito") %>
                                    </td>

                                    <td>
                                        <a href='<%# "~/MonstroEfeito?view=1&id=" + Eval("IdMonstroEfeito") %>'
                                            runat="server">
                                    ...
                                    <td>
                                        <a href='<%# "~/MonstroEfeito?id=" + Eval("IdMonstroEfeito") %>'
                                            runat="server">
                                    ...
                                    <td>
                                        <p>
                                            <asp:ImageButton
                                                ID="btn_VerificaTipo"
                                                ImageUrl="~/imagens/add.png"
                                                runat="server"
                                                Style="max-width: 20px;"
                                                OnCommand="btn_VerificaMonstro_Command"
                                                CommandArgument='<%# Eval("NomeMonstroEfeito") %>'
                                                CommandName="VerificaTipo"
                                                OnClientClick="return ('Acesse o link para cadastrar')" />
                                        </p>
                                    </td>
                                </tr>
                            </ItemTemplate>
                            ...
                            <EmptyItemTemplate>
                                <%--Não existem itens!!--%>
                                <strong>Não existem Monstro Efeitos cadastrados!</strong>
                            </EmptyItemTemplate>
                        </asp:ListView>
                    </table>
                </form>
