<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="FrmTipoMagia.aspx.cs" Inherits="YugiohApp.Tipo_Carta.TipoMagia.FrmTipoMagia" %>
...
<head runat="server">
    ...
    <title>Gerenciamento de Magia</title>
...
<body id="page-top">
    ...
    <header class="masthead bg-primary text-white text-center">
        <div class="container px-4 text-center">
            ...
            <h2 class="fw-bold">Cadastre uma Magia!</h2>
        </div>
    </header>
    <style>
        #portfolio {
            ...
            <div class="col-lg-8 col-xl-7">
                <form id="form1" runat="server" style="border-style: groove; padding: 1.5rem; border-radius: 10px; box-shadow: 15px;">
                    <div class="form-floating mb-3">
                        <div>
                            <label>Adicionar Magia:</label>
                        </div>
                        <div>
                            <asp:TextBox
                                runat="server" ID="txtMagia" class="form-control" data-sb-validations="required" />
                        </div>
                    </div>
                    ...
                    <table border="1" class="list-group-item-action bg-gradient">
                        ...
                        <asp:ListView runat="server" ID="lvMagia">
                            <ItemTemplate>
                                <tr>
                                    <td>
                                        <%# Eval("IdMagia") %>
                                    ...
                                    <td>
                                        <a href='<%# "~/Magia?view=1&id=" + Eval("IdMagia") %>'
                                            runat="server">
                            ...
                            <EmptyItemTemplate>
                                <%--Não existem itens!!--%>
                                <strong>Não existem Magias cadastrados!</strong>
                            </EmptyItemTemplate>
                        </asp:ListView>
                    </table>
                </form>
