<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="FrmTipoArmadilha.aspx.cs" Inherits="YugiohApp.Tipo_Carta.TipoArmadilha.FrmTipoArmadilha" %>
...
<head runat="server">
    ...
    <title>Gerenciamento de Armadilha</title>
...
<body id="page-top">
    ...
    <header class="masthead bg-primary text-white text-center">
        <div class="container px-4 text-center">
            ...
            <h2 class="fw-bold">Cadastre uma Armadilha!</h2>
        </div>
    </header>
    <style>
        #portfolio {
            ...
            <div class="col-lg-8 col-xl-7">
                <form id="form1" runat="server" style="border-style: groove; padding: 1.5rem; border-radius: 10px; box-shadow: 15px;">
                    <div class="form-floating mb-3">
                        <div>
                            <label>Adicionar Armadilha:</label>
                        </div>
                        <div>
                            <asp:TextBox
                                runat="server" ID="txtArmadilha" class="form-control" data-sb-validations="required" />
                        </div>
                    </div>
                    ...
                    <table border="1" class="list-group-item-action bg-gradient">
                        <thead>
                            <tr>
                                <td>Código</td>
                                <td>Nome Armadilha</td>
                                <td colspan="3">Ações</td>
                            </tr>
                        </thead>
                        <asp:ListView runat="server" ID="lvArmadilha">
                            <ItemTemplate>
                                <tr>
                                    <td>
                                        <%# Eval("IdArmadilha") %>
                                    ...
                                    <td>
                                        <a href='<%# "~/Armadilha?view=1&id=" + Eval("IdArmadilha") %>'
                                            runat="server">
                                    ...
                                    <td>
                                        <a href='<%# "~/Armadilha?id=" + Eval("IdArmadilha") %>'
                                            runat="server">
                            ...
                            <EmptyItemTemplate>
                                <%--Não existem itens!!--%>
                                <strong>Não existem Armadilhas cadastrados!</strong>
                            </EmptyItemTemplate>
                        </asp:ListView>
                    </table>
                </form>
